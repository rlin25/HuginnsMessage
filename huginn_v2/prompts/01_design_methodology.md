...
**Exit criterion:** Every discrepancy identified during the inspection pass has been either corrected in a document or recorded as a known issue with an explicit deferral note. No open findings remain. When this condition is met, the Web Project resumes for v2 design — not before.

The Web Project's role after Phase 7 is v2 design only.
